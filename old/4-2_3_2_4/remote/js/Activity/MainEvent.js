...
export class MainEvent {
    ...
    Init() {
        ...
        this.concept_learning.addEventListener("callToParent", (event) => {
            {
                ...
                if (event.detail.message.type === "popup") {
                    ...
                    if (this.checkPhone()) {
                        ...
                        if (page === "0") {
                            if (index === 0) {
                                this.keyboard.style.top = "250px";
                                tail.style.top = "185px";
                            } else {
                                this.keyboard.style.top = "310px";
                                tail.style.top = "448px";
                            }
                        } else if (page === "1") {
                            if (index === 0) {
                                this.keyboard.style.top = "250px";
        ...
        this.capture.addEventListener("click", (e) => {
            let fileName = '4학년_2학기_3단원_2~4차시_';
