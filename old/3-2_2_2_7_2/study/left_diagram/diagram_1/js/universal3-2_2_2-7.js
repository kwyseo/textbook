...
import {ShowOneSecond} from "./Utill/AlertController.js";
...
window.addEventListener("script-loaded", async function (e) {
    ...
    mainActivity.shadow.checkDrag = ()=> {
        // 모두 완료했는지 확인한다.
        const result = mainActivity.activity2.CheckDrag();
        if(!result){
