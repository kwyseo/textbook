...
const activateQuestion = (containerIndex)=>{
    ...
    */
    ...
    if(containerIndex === 0 || containerIndex===1){
        if(aniEmbed.shadowRoot.showStepOneWithIntro)
            aniEmbed.shadowRoot.showStepOneWithIntro(containerIndex!==0);
    }else{
        if(aniEmbed.shadowRoot.showStepOne)
            aniEmbed.shadowRoot.showStepOne(containerIndex!==2);
    }
}
