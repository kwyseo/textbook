...
export class MainEvent {
    ...
    Init() {
        ...
        this.problem_solving.addEventListener("callToParent", (event)=>{{
            ...
            if(event.detail.message.type==="keyboard"){
                if(this.checkPhone()) {
                    ...
                    this.keyboardTarget = event.detail.message.target;
                }
        ...
        this.capture.addEventListener("click", (e) => {
            let fileName = '4학년_1학기_2단원_2~6차시_';
    ...
    OnClickQWERTY(value){
        const shadowRoot = this.problem_solving.querySelector("remote-html-embed").shadowRoot;
        shadowRoot.quertyClicked(value, this.keyboardTarget);
    }
